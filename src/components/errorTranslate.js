const errorDict = {
    ...
    "Passwords provided didn't match": "Los passwords no coinciden",
    "Failed to update icon. Formats allowed: jpeg, png, bmp, webp": "No se pudo modificar el avatar. Formatos permitidos: jpeg, png, bmp, webp",
    "Failed to update icon. Largest size allowed is 2 MB": "No se pudo modificar el avatar. Tamaño máximo permitido es 2 MB",
    "Incorrect email or password": "Password o email incorrectos",
    "Not authenticated": "Usuario no autenticado",
    "Expired signature, you need to login again": "Token expirado. Logueate de nuevo para continuar",
    ...
    "Game not found": "No se pudo encontrar la partida",
    ...
    "The game must have at least 5 players": "La partida debe tener cinco (5) jugadores por lo menos",
    ...
    "You cant start the game, you are not the owner!": "No puedes comenzar la partida, no eres el dueño!",
    ...
    "Already taken the cards in this turn": "Las cartas ya han sido tomadas en este turno",
    "Cards were not taken by minister in this turn": "Las cartas no fueron tomadas en este turno",
    "No turn started yet": "Ningún turno ha comenzado aún",
    "Director already promulgated in this turn": "El director ya ha promulgado durante el turno",
    "Player is not minister": "El jugador no es el ministro",
    "Must promulgate in current turn before execute a spell": "Debe haber una promulgación antes de ejecutar un hechizo",
    ...
    "A spell is available and need to be used before start of next turn": "Un hechizo está disponible y debe ser usado antes de pasar al siguiente turno",
    "Already set director candidate in current turn": "Ya se ha elegido a un candidato a director durante este turno",
